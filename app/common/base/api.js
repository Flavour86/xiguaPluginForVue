/*
 *该api为content-scripts仅单处调用的api；过api多处调用，仅用谷歌通信处理，目的：为维护开发方便
 */
export let API = {
	path: {
	...
	hostName: 'https://chromepluginapi.xiguaji.com',
	getApiUrl: function(pathName) {
		return this.hostName + this.path[pathName]
	}
}
